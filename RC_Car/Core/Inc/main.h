...
/* Private defines -----------------------------------------------------------*/
#define FORWARD_PWM_Pin GPIO_PIN_3
#define FORWARD_PWM_GPIO_Port GPIOE
#define BACKWARD_PWM_Pin GPIO_PIN_4
#define BACKWARD_PWM_GPIO_Port GPIOE
...
#define BACKWARD_Pin GPIO_PIN_2
