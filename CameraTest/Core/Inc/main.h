...
/* Private defines -----------------------------------------------------------*/
#define CAM_MCLK_Pin GPIO_PIN_4
#define CAM_MCLK_GPIO_Port GPIOE
#define CAM_VS_Pin GPIO_PIN_5
#define CAM_VS_GPIO_Port GPIOE
#define CAM_HS_Pin GPIO_PIN_6
#define CAM_HS_GPIO_Port GPIOE
#define B1_Pin GPIO_PIN_13
#define B1_GPIO_Port GPIOC
#define CAM_D4_Pin GPIO_PIN_0
#define CAM_D4_GPIO_Port GPIOF
#define CAM_D5_Pin GPIO_PIN_1
#define CAM_D5_GPIO_Port GPIOF
#define CAM_D6_Pin GPIO_PIN_2
#define CAM_D6_GPIO_Port GPIOF
#define CAM_D7_Pin GPIO_PIN_3
#define CAM_D7_GPIO_Port GPIOF
#define CAM_D2_Pin GPIO_PIN_7
...
#define CAM_PWNN_Pin GPIO_PIN_7
#define CAM_PWNN_GPIO_Port GPIOD
